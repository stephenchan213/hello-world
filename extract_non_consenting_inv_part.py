...
def process_stock_code(stock_code):
    ...
    try:
        ...
        table_headers = [header.text.strip() for header in soup.find('div', class_='ccass-search-headerrow').find_parent('div', class_='container content-container ccass-search-container content-container-reset').find_all('div', class_='header')]
        print(table_headers)                                                                                        
